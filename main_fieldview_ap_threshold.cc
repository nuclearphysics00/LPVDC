...
#if defined(GEOM_PLATE)
   geo = Detector::PAP_PlaneCathode_Periodic(0.60, 0.50); // for nomal type
  // geo = Detector::PAP_PlaneCathode_Periodic(0.20, 0.50); // for all anodes
  // geo = Detector::PAP_PlaneCathode_Periodic(0.40, 0.50); // for ap ap ap 
#elif defined(GEOM_WIRE)
   geo = Detector::PAP_WireCathode_Periodic(0.60, 0.50); // for nomal type
  // geo = Detector::PAP_WireCathode_Periodic(0.20, 0.50); // for all anodes
  // geo = Detector::PAP_WireCathode_Periodic(0.40, 0.50); // for ap ap ap
#endif
