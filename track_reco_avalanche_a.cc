...
int main(int argc, char** argv) {
  ...
  if (argc > 1) {
    ...
    const char* defaultTimeHistFile = "root/run_20260322_203004_a_wire/analysis_L0_prim/t_hist_nt.csv";
  #elif defined(GEOM_PLATE)
    const char* geomTag = "plate";
    const char* defaultTimeHistFile = "root/run_20260322_203006_a_plate/analysis_L0_prim/t_hist_nt.csv";
  #else
...
#if defined(GEOM_PLATE)
  // ===== Plane cathode 用 =====
  const double pitchSense    = 0.20;   // [cm]
